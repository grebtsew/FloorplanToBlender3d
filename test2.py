...
def find_rooms(img, noise_removal_threshold=50, corners_threshold=0.9,
               room_closing_max_length=1000000, gap_in_wall_threshold=10):
    """
...
boxes, img = detect.detectPreciseBoxes(gray, blank_image)

gray = ~gray

#height, width = gray.shape[:2]
rooms, colored_house = find_rooms(gray.copy())



cv2.imshow('resul2t', colored_house)
cv2.imshow('resul2t2', gray)
cv2.waitKey()
