...
def test(path):
    ...
    Detect rooms
    '''
    rooms, colored_rooms = detect.find_rooms(gray.copy(), noise_removal_threshold=50, corners_threshold=0.01, room_closing_max_length=130, gap_in_wall_min_threshold=5000)
    ...
    Detect details
    '''
    doors, colored_doors = detect.find_details(gray.copy(), noise_removal_threshold=50, corners_threshold=0.01, room_closing_max_length=130, gap_in_wall_max_threshold=5000, gap_in_wall_min_threshold=10)
