...
if __name__ == "__main__":
    ...
    blender_script_path = (
        floorplan_lib_path + "/Blender/floorplan_to_3dObject_in_blender.py"
    )
    ...
    image_paths = [
        (floorplan_lib_path + "/Images/example.png", (1, 1, 1)),
        (floorplan_lib_path + "/Images/example.png", (20, 1, 1)),
        (floorplan_lib_path + "/Images/example.png", (-10, 1, 1)),
    ]
