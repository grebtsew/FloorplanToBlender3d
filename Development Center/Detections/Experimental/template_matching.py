...
window_image_path = os.path.dirname(os.path.realpath(__file__))+"/../../../Images/window.png"
text_image_path = os.path.dirname(os.path.realpath(__file__))+"/../../../Images/text.png"
